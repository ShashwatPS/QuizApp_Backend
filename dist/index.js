...
app.post('/unsolved-questions', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const solvedQuestions = yield prisma.teamProgress.findMany({
            where: { team_name, is_completed: true },
            select: { question_id: true }
        });
        const solvedQuestionIds = solvedQuestions.map(tp => tp.question_id);
        const unsolvedQuestions = yield prisma.question.findMany({
            where: {
                NOT: {
                    question_id: {
...
app.get('/get-teams', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const sortedTeams = teams.sort((a, b) => {
            if (a.team_progress.length === 0)
                return 1;
            if (b.team_progress.length === 0)
                return -1;
            // @ts-ignore
